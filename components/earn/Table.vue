<template>
  <div class="container2">
    ...
    <table class="tableearn">
      ...
      <tbody>
        <tr>
          <td class="cell">LUNA/ATOM</td>
          <td class="cell">
            <img src="icon/LUNA-Atom.svg" />
          </td>
          <td class="cell">1-7-14 days</td>
          <td class="cell">${{ tvlData572 | bigFigureOrShortDecimals }}</td>
          <td class="cell">{{ apr572 }}% + {{ bonus572 }}% BONUS LUNA</td>
          <td class="cell">
            <CommonButton
        ...
        <tr>
          <td class="cell">LUNA/OSMO</td>
          <td class="cell">
            <img src="icon/LUNA-Osmo.svg" width="80" height="45" />
          </td>
          <td class="cell">1-7-14 days</td>
          <td class="cell">${{ tvlData571 | bigFigureOrShortDecimals }}</td>
          <td class="cell">{{ apr571 }}% + {{ bonus571 }}% BONUS LUNA</td>
          <td class="cell">
            <CommonButton
    ...
    <table class="tableearn">
      ...
      <tbody>
        <tr>
          <td class="cell">Terra Delegate</td>
          <td class="cell">
            <img src="icon/LUNA-icon.svg" width="45" height="45" />
          </td>
          <td class="cell">14 days</td>
          <td class="cell">
            ${{ returnLunaBonded | bigFigureOrShortDecimals }}
          </td>
          <td class="cell">
            {{ lunaApr | bigFigureOrShortDecimals }}% (excl. commission)
        ...
        <tr>
          <td class="cell">Terra Validate</td>
          <td class="cell">
            <img src="icon/LUNA-icon.svg" width="45" height="45" />
          </td>
          <td class="cell">NA</td>
...
export default {
  ...
  computed: {
    ...mapState([`session`]),
    ...mapState(`data`, ['lunaApr', 'lunaValue', 'validatorInfoPage']),
    returnLunaBonded() {
      const finalBonded =
        (this.validatorInfoPage.bonded_tokens / 1000000) * this.lunaValue
      return finalBonded
    },
  },
  async beforeMount() {
    ...
    // console.log(this.lunaValue)
    const finalBonus571 = (
      ((1600000 * this.lunaValue) / 180 / responseData571.data[0].liquidity) *
      365 *
      100
    ).toFixed(2)
    ...
    const finalBonus572 = (
      ((2400000 * this.lunaValue) / 180 / responseData572.data[0].liquidity) *
      365 *
      100
    ).toFixed(2)

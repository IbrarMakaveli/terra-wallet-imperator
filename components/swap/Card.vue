  ...
  <div v-if="step === 'Step 1'">
    ...
    <CommonForm :submit="onSubmit" class="session-container">
      <div class="paragraph content">
        It is mandatory to swap your LUNA coins from the
        <span class="bold">old</span> Terra blockchain to the
        <span class="bold">new</span> blockchain. Swapping your coins only
        requires 2 steps.
      </div>
      <div class="paragraph content">
        Before you start make sure you have your Terra wallet (<span
          class="bold"
          >old</span
        >
      ...
      <div class="paragraph step-content">
        <span class="bold"
          >Step 1: Confirm that the address below is your new LUNA (Cosmos)
          address</span
        >
        (see top left corner in the web wallet) to receive your
        <span class="bold">new</span> LUNA coins.
      </div>
  ...
  <div v-else-if="step === 'Step 2'">
    ...
    <div class="session-container">
      <div class="paragraph content">
        ...
        <span class="bold">old</span> Terra blockchain.
      </div>
      <div class="paragraph content">
        To receive your new LUNA coins, you must send your
        <span class="bold">old</span> LUNA coins to this unique
      ...
      <div class="paragraph step-content">
        <span class="bold"
          >Step 2: Send your old LUNA coins to the unique deposit address
          below.</span
        ><br />
        Once you have sent your coins, you’ll receive the
        <span class="bold">new</span> LUNA coins in the web wallet
      ...
      <div class="paragraph content">
        ...
        received on your <span class="bold">new</span> LUNA address.
      </div>
      ...
      <div class="session-footer second-step">
        ...
        <CommonButton
          :href="network.txsExplorerURL + '/mainnet/address/' + cosmosAddress"
          value="View address"
          :link="true"
        />
      </div>
